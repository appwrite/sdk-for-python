...
class Account(Service):
    ...
    def create_challenge(self, provider):
    ...
    def add_authenticator(self, factor):
        """Add Authenticator"""
        ...
        api_path = api_path.replace('{factor}', factor)
    ...
    def verify_authenticator(self, factor, otp):
    ...
    def delete_authenticator(self, provider, otp):
