...
class Backups(Service):
    ...
    def create_archive(self, services: List[str], resource_id: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def create_policy(self, policy_id: str, services: List[str], retention: float, schedule: str, name: Optional[str] = None, resource_id: Optional[str] = None, enabled: Optional[bool] = None) -> Dict[str, Any]:
        """
    ...
    def create_restoration(self, archive_id: str, services: List[str], new_resource_id: Optional[str] = None, new_resource_name: Optional[str] = None) -> Dict[str, Any]:
        """
