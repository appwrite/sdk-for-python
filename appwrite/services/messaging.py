...
class Messaging(Service):
    ...
    def update_smtp_provider(self, provider_id, name = None, host = None, port = None, username = None, password = None, encryption = None, auto_tls = None, from_name = None, from_email = None, reply_to_name = None, reply_to_email = None, enabled = None):
    ...
    def create_telesign_provider(self, provider_id, name, xfrom = None, username = None, password = None, enabled = None):
    ...
    def update_telesign_provider(self, provider_id, name = None, enabled = None, username = None, password = None, xfrom = None):
