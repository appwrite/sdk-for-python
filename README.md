...
Appwrite is an open-source backend used as a service server that abstract and simplify the complex and repetitive development tasks behind a very simple to use REST API. Appwrite aims to help you to develop or genertate your apps faster and in a more secure way.
